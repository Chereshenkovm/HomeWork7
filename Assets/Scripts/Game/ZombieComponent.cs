    ...
    public class ZombieComponent : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (IsAlive)
            {
                ...
                switch (getActionName(distance, rockDistance, hasFound, isThereRocks))
                {
                    case "player":
        ...
        private string getActionName(Vector3 playerDist, float rockDist, bool foundPlayer, bool rocksExist)
        {
            ...
            pointsAc[1] = (playerDist.magnitude > 10 ? 150 : 0) + (rockDist <= 10 ? 50 : 0) + (hasRock ? -1000 : 0) +
                          (!rocksExist ? -1000 : 0);
            pointsAc[2] = (rockDist < 1f ? 1000 : 0) + (hasRock ? -1000 : 0);
            pointsAc[3] = (playerDist.magnitude < 5 ? 200 : 0) + (hasRock ? 100 : -1000);
            pointsAc[4] = (playerDist.magnitude <= 1f ? 1001: 0);
